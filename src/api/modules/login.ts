...
import { PORT1, PORT6 } from "@/api/config/servicePort";
...
export const loginApi = (params: Login.ReqLoginForm) => {
	return http.post<Login.ResLogin>(PORT6 + `/login`, params, { headers: { noLoading: true } }); // 正常 post json 请求  ==>  application/json
...
// export const getAuthMenuListApi = () => {
// 	return http.get<Menu.MenuOptions[]>(`/get_menu`, {}, { headers: { noLoading: true } });
// 	// 如果想让菜单变为本地数据，注释上一行代码，并引入本地 dynamicRouter.json 数据
// 	return DynamicRouter;
// };
